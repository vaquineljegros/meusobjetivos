const botoes = document.querySelectorAll(".botao"). const textos = document.querySelectorAll("aba-conteudo");
...
function comeca Cronometro(){ atualiza Cronometro(); setInterval(atualiza Cronometro, 1000);
